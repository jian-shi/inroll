    ...
    @section('content')
        <div class="col-sm-12">
            {!! Form::open(['method'=> 'GET', 'class'=>'form-horizontal']) !!}
                ...
                <div class="col-sm-2"><button type="submit" name="search" value="Search" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-search"></span> Search</button></div>

                @if ($count_elector>0) <div class="col-sm-2"><button type="button" name="search" value="Search" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-cloud-download"></span> Download</button></div> @endif
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    {!! Form::submit('Download List',  ['name'=>'download','value'=>'Search','class'=> 'btn btn-primary btn-md pull-left']) !!}
                          </div>
                  </div>
                </div>
